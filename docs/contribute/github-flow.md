...
<!-- Title: Contributing GithubFlow FlutterLearning -->
...
To contribute to flutter-learning project on [GitHub](https://github.com/luismayta/flutter-learning), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/luismayta/flutter-learning/pulls).
...
To follow the instructions in this guide and start contributing to flutter-learning project on GitHub:
...
```bash
git remote add upstream  https://github.com/luismayta/flutter-learning.git
```

Now your **upstream** points to **luismayta/flutter-learning**.
...
git fetch upstream # assuming upstream is luismayta/flutter-learning
...
All merge requests are automatically tested using [Github Actions](https://github.com/luismayta/flutter-learning/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
